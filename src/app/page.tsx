    ...
    <PublicShell>
      <section className="flex flex-col items-center justify-center gap-6 px-6 py-24 text-center md:py-36">
        ...
        <p className="max-w-xl text-lg text-muted-foreground md:text-xl">
          BrainLS uses spaced repetition to help you master any subject. Create flashcards with rich
          markdown, study smarter, and track your progress over time.
        </p>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-4 rounded-lg border bg-background p-6">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Studying outdated or incorrect cards does more harm than good. AI flags questionable
                content and verifies facts so you can trust what you&apos;re committing to memory.
              </p>
            </div>
      ...
      <section className="border-t bg-muted/30 px-6 py-20 md:px-12">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-xl text-muted-foreground">
            ...
            import. And if you ever want to go back, export everything to Anki format — no lock-in,
            ever.
          </p>
        </div>
      </section>
      ...
      <section className="border-t px-6 py-20 md:px-12">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto mb-12 max-w-2xl text-center text-muted-foreground">
            Instead of cramming, spaced repetition schedules reviews at increasing intervals — right
            before you forget. It&apos;s the most efficient way to move knowledge into long-term
            memory.
          </p>
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Each successful review pushes the next one further out. Hard cards come back sooner.
              </p>
            </div>
          </div>
        </div>
