...
- You have a budget of ${ctx.maxIterations} tool-use rounds. Each round can contain multiple parallel tool calls. Batch independent calls into a single round to stay within budget.
