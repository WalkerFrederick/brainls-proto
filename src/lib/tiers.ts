...
export const TIERS = {
  free: { label: "Free", aiRequests: 5, aiPeriod: "day" as const },
  plus: { label: "Plus", aiRequests: 200, aiPeriod: "month" as const },
  pro: { label: "Pro", aiRequests: 1000, aiPeriod: "month" as const },
};
